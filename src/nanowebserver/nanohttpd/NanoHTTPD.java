...
public abstract class NanoHTTPD {
						...
						asyncRunner.exec(new Runnable() {
							...
							public void run() {
								...
								try {
									...
									//while (!finalAccept.isClosed())  //JNV 06-24-2020
									if (!finalAccept.isClosed())       //JNV 06-24-2020
										session.execute();
								} catch (Exception e) {
	 ...
	 * @param parms   Parsed, percent decoded parameters from URI and, in case
	 *                of POST, data.
	...
	public static final class ResponseException extends Exception {
        ...
        private static final long serialVersionUID = -895482450671420401L;
